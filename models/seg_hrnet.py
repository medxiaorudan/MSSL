...
#        print("########################")
#        self.params = config['MODEL']['EXTRA']['STAGE4']
#        print("########################")
        # stem net
...
#class HighResolutionHeadClassify(nn.Module):
#    def __init__(self, backbone_channels, num_outputs):
#        super(HighResolutionHeadClassify, self).__init__()
#        last_inp_channels = sum(backbone_channels)
#        self.last_layer = nn.Sequential(
#            nn.Conv2d(
#                in_channels=last_inp_channels,
...
#            nn.Dropout(0.4))
#        self.out_layer = nn.Linear(2048, num_outputs)
            

class HighResolutionHeadClassify(nn.Module):
    def __init__(self, pre_stage_channels, num_outputs):
    
        super(HighResolutionHeadClassify, self).__init__()

        self.incre_modules, self.downsamp_modules, self.final_layer = self._make_head(pre_stage_channels)
        self.classifier = nn.Linear(2048, num_outputs)
        self.sigmoid = nn.Sigmoid()
