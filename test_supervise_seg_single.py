...
#        spaces = ''
#        for j in range(0, 1 - len(cat_names[i])):
#            spaces += ' '
...
#        db_loader = torch.utils.data.DataLoader(db, batch_size=2, shuffle=False, num_workers=0)
#        print("$$$$$$$$$$$$$$$$$$$$")
#        print("len(db):",len(db))
#        print("$$$$$$$$$$$$$$$$$$$$$")
#    elif database == 'NYUD':
...
#    model = torch.nn.DataParallel(model, device_ids=range(torch.cuda.device_count()))
    ...
    # load model weights
    weights_path = "/data/morpheme/user/rxiao/MIDL/deep_learning/Multi-task/results_supervise/RCCContext/hrnet_w18/single_task/SSL_S/best_model.pth.tar"
